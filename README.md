...
מכסת 5 השעות של מנוי Claude לא מתחילה בשעה קבועה. היא מתחילה בפנייה הראשונה אחרי שהחלון הקודם נסגר. לכן כשמתיישבים לעבוד אחרי הפסקה, נפתח חלון חדש, ויש 5 שעות מלאות עד האיפוס. מי שגומר את המכסה אחרי שעתיים, מחכה שלוש.
...
<p dir="rtl" align="center">מתיישבים לעבוד: 0% ניצול, ורק 35 דקות עד האיפוס. אפשר לשרוף עכשיו מכסה מלאה, ובעוד חצי שעה מתקבלת עוד אחת.</p>
