...
זמן ההמתנה עד האיפוס הראשון:

<table dir="rtl">
<tr><th>המכסה נגמרת אחרי</th><th>בלי השומר</th><th>עם השומר (בממוצע)</th></tr>
<tr><td>שעה</td><td>4 שעות</td><td>שעה וחצי</td></tr>
<tr><td>שעתיים</td><td>3 שעות</td><td>שעה</td></tr>
<tr><td>3 שעות</td><td>שעתיים</td><td>חצי שעה</td></tr>
</table>

<ul dir="rtl">
<li><b>זה בא לידי ביטוי רק אחרי הפסקה ארוכה.</b> כל עוד עובדים ברציפות, החלונות ממילא נפתחים אחד אחרי השני. ההבדל מופיע כשחוזרים לעבוד, למשל בבוקר או אחרי הפסקת צהריים, והחלון הקודם כבר נסגר בינתיים.</li>
...
משימה מתוזמנת של Windows רצה בשקט ברקע, כל 10 דקות:

<ol dir="rtl">
<li><b>חלון המכסה עדיין פתוח ←</b> המשימה מתבטלת.</li>
...
<li>כלי Claude Code בהתקנה הנייטיב (<code>claude.exe</code> תחת <code>~/.local/bin</code>), מחובר <b>למנוי</b> Pro או Max (בעבודה עם מפתח API אין ממילא חלון של 5 שעות, ואין מה לקצר)</li>
</ul>
...
<tr><td>פניות למודל</td><td>אחת לכל חלון, כלומר בערך חמש ביום, כולן ל-Haiku, בכמות טוקנים מזערית ביותר</td></tr>
